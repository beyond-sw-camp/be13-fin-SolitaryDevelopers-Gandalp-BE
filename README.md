...
|---	|---	|
|   이덕찬 	|    |
|   이창신 	| 프로젝트 전반적으로 기획했던 내용이 잘 구현되어 뿌듯하고 지난번 프로젝트보다 조금 난이도 있는 구현 파트를 진행하고 완성하면서 적절한 환경과 공부 그리고 노력이 더해지면 중간에 어려움이 있어도 이겨내어서 맡은 일을 잘 해낼 수 있겠다는 자신감이 생겼습니다. 제가 직접 구현한 기능은 아니지만 팀원들과 프로젝트 토의 진행과 함께 협업하면서 웹소켓을 사용하면 이러한 기능에 활용할 수 있고 AI를 통해 이렇게도 사용할 수 있다는 것을 몸소 경험하면서 프로젝트에 대한 관점이 넓어지는 시각을 가지게 된 것 같아 좋았습니다.   |
|   임현조 	|    |
|   차경태 	|    |
|   홍도현	|    |
